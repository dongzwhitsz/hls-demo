...
// ==============================================================
#ifndef __top_fcmp_32ns_32nEe0__HH__
#define __top_fcmp_32ns_32nEe0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_fcmp_32ns_32nEe0) {
    ...
    SC_CTOR(top_fcmp_32ns_32nEe0):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
