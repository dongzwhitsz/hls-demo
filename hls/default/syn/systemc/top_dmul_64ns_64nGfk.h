...
// ==============================================================
#ifndef __top_dmul_64ns_64nGfk__HH__
#define __top_dmul_64ns_64nGfk__HH__
#include "ACMP_dmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_dmul_64ns_64nGfk) {
    ...
    SC_CTOR(top_dmul_64ns_64nGfk):  ACMP_dmul_U ("ACMP_dmul_U") {
        ACMP_dmul_U.clk(clk);
