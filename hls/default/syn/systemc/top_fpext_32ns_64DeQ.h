...
// ==============================================================
#ifndef __top_fpext_32ns_64DeQ__HH__
#define __top_fpext_32ns_64DeQ__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_fpext_32ns_64DeQ) {
    ...
    SC_CTOR(top_fpext_32ns_64DeQ):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
