...
// ==============================================================
#ifndef __top_fadd_32ns_32nAem__HH__
#define __top_fadd_32ns_32nAem__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_fadd_32ns_32nAem) {
    ...
    SC_CTOR(top_fadd_32ns_32nAem):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
