...
// ==============================================================
#ifndef __top_dadd_64ns_64nFfa__HH__
#define __top_dadd_64ns_64nFfa__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_dadd_64ns_64nFfa) {
    ...
    SC_CTOR(top_dadd_64ns_64nFfa):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
