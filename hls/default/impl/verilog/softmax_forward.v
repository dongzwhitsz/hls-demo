...
wire   [11:0] tmp_cast_fu_175_p1;
reg   [11:0] tmp_cast_reg_262;
wire   [0:0] exitcond2_fu_158_p2;
reg   [3:0] softmax_output_addr_reg_267;
wire   [7:0] j_1_fu_185_p2;
reg   [7:0] j_1_reg_275;
wire    ap_CS_fsm_state3;
wire   [0:0] exitcond1_fu_179_p2;
reg   [31:0] softmax_kernel_load_reg_290;
wire    ap_CS_fsm_state4;
reg   [31:0] dense_output_load_reg_295;
wire   [31:0] grp_fu_148_p2;
reg   [31:0] tmp_8_reg_300;
wire    ap_CS_fsm_state7;
wire   [3:0] i_2_fu_242_p2;
reg   [3:0] i_2_reg_308;
wire    ap_CS_fsm_state12;
wire   [0:0] exitcond_fu_236_p2;
reg   [3:0] softmax_output_addr_1_reg_318;
reg   [31:0] softmax_bias_load_reg_323;
wire    ap_CS_fsm_state13;
reg   [31:0] softmax_output_load_reg_328;
reg   [3:0] i_reg_97;
reg   [31:0] storemerge_reg_108;
reg   [7:0] j_reg_121;
reg   [3:0] i1_reg_132;
wire    ap_CS_fsm_state18;
wire   [63:0] tmp_fu_170_p1;
wire   [63:0] tmp_11_cast_fu_231_p1;
wire   [63:0] tmp_7_fu_191_p1;
...
wire   [10:0] tmp_5_fu_196_p3;
wire   [8:0] tmp_6_fu_208_p3;
wire   [11:0] p_shl1_cast_fu_216_p1;
wire   [11:0] p_shl_cast_fu_204_p1;
wire   [11:0] tmp_s_fu_220_p2;
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_158_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i1_reg_132 <= 4'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (exitcond1_fu_179_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((exitcond2_fu_158_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_reg_121 <= 8'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_236_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state12))) begin
        softmax_output_addr_1_reg_318 <= tmp_3_fu_248_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond2_fu_158_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        softmax_output_addr_reg_267 <= tmp_fu_170_p1;
        tmp_cast_reg_262[3 : 0] <= tmp_cast_fu_175_p1[3 : 0];
    end
end
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state12) & (exitcond_fu_236_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (exitcond_fu_236_p2 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state18)) begin
        ...
        softmax_output_address0 = tmp_3_fu_248_p1;
...
assign dense_output_address0 = tmp_7_fu_191_p1;

assign exitcond1_fu_179_p2 = ((j_reg_121 == 8'd128) ? 1'b1 : 1'b0);

assign exitcond2_fu_158_p2 = ((i_reg_97 == 4'd10) ? 1'b1 : 1'b0);

assign exitcond_fu_236_p2 = ((i1_reg_132 == 4'd10) ? 1'b1 : 1'b0);

assign i_2_fu_242_p2 = (i1_reg_132 + 4'd1);

assign i_3_fu_164_p2 = (i_reg_97 + 4'd1);

assign j_1_fu_185_p2 = (j_reg_121 + 8'd1);

assign p_shl1_cast_fu_216_p1 = tmp_6_fu_208_p3;

assign p_shl_cast_fu_204_p1 = tmp_5_fu_196_p3;

assign softmax_bias_address0 = tmp_3_fu_248_p1;

assign softmax_kernel_address0 = tmp_11_cast_fu_231_p1;

assign tmp_11_cast_fu_231_p1 = tmp_1_fu_226_p2;

assign tmp_1_fu_226_p2 = (tmp_s_fu_220_p2 + tmp_cast_reg_262);

assign tmp_3_fu_248_p1 = i1_reg_132;

assign tmp_5_fu_196_p3 = {{j_reg_121}, {3'd0}};

assign tmp_6_fu_208_p3 = {{j_reg_121}, {1'd0}};

assign tmp_7_fu_191_p1 = j_reg_121;

assign tmp_cast_fu_175_p1 = i_reg_97;

assign tmp_fu_170_p1 = i_reg_97;

assign tmp_s_fu_220_p2 = (p_shl1_cast_fu_216_p1 + p_shl_cast_fu_204_p1);

always @ (posedge ap_clk) begin
    tmp_cast_reg_262[11:4] <= 8'b00000000;
end
