...
def train():
    (x_train, y_train), (x_test, y_test) = tf.keras.datasets.mnist.load_data('C:\\Users\\dongzw\\Desktop\\fpga\\lstm-master\\input\\mnist/mnist.npz')
    ...
    model = get_model()
    model.fit(x=x_train, y=y_train, batch_size=20, epochs=1, validation_data=(x_test, y_test))
